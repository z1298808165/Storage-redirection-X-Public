...
mod tests {
    ...
    #[test]
    fn recent_caller_reuse_is_disabled_for_system_writers() {
        assert!(!should_reuse_recent_current_caller_for_process(
    ...
    #[test]
    fn unresolved_external_uid_is_preserved_only_for_system_writers() {
        assert!(should_preserve_unresolved_external_uid(
            "com.android.providers.media.module",
            10399
        ));
        assert!(!should_preserve_unresolved_external_uid(
    ...
    #[test]
    fn recent_external_uid_reuse_requires_system_writer_and_signal_origin() {
        assert!(should_reuse_recent_external_signal_for_system_writer(
            "com.android.providers.media.module",
            10164,
            12,
            true
