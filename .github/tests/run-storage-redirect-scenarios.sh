...
prepare_backend_core_targets() {
  if ! adb_su "mkdir -p '${BACKEND_ROOT}/Download/SrtProbe' '${BACKEND_ROOT}/Download/Test' '${BACKEND_ROOT}/Download/SrtMapOnlyMapped' '${BACKEND_ROOT}/Download/SrtReadOnly' '${BACKEND_ROOT}/Download/SrtMapRO' '${BACKEND_ROOT}/Download/SrtAllow/tmp' '${BACKEND_ROOT}/Pictures/SrtLocked' '${BACKEND_ROOT}/Pictures/SrtReadOnlyMedia' '${BACKEND_ROOT}/.xldownload' '${BACKEND_ROOT}/.xlDownload'; chmod -R 777 '${BACKEND_ROOT}/Download/SrtProbe' '${BACKEND_ROOT}/Download/Test' '${BACKEND_ROOT}/Download/SrtMapOnlyMapped' '${BACKEND_ROOT}/Download/SrtReadOnly' '${BACKEND_ROOT}/Download/SrtMapRO' '${BACKEND_ROOT}/Download/SrtAllow' '${BACKEND_ROOT}/Pictures/SrtLocked' '${BACKEND_ROOT}/Pictures/SrtReadOnlyMedia' 2>/dev/null || true; chmod 777 '${BACKEND_ROOT}/.xldownload' '${BACKEND_ROOT}/.xlDownload' 2>/dev/null || true; test -d '${BACKEND_ROOT}/Download/SrtProbe' && test -d '${BACKEND_ROOT}/Download/Test'" >/dev/null; then
