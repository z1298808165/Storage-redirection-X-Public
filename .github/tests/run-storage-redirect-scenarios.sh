...
wait_real_root_writable() {
  ...
  echo "Timed out waiting for writable storage root: ${label}" >&2
  print_storage_state "${label}-writable-timeout"
  return 1
}
