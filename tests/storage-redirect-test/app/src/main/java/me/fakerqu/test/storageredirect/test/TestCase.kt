...
enum class TestCase(val id: String) {
  ...
  MEDIASTORE_QUERY_READ_ONLY_IMAGE("mediastore_query_read_only_image"),
  ...
  FILE_WRITE_THEN_OVERWRITE("file_write_then_overwrite"),
  ...
  fun getMediaType(): MediaStoreApi.MediaType? =
      when (this) {
        ...
        MEDIASTORE_THUMBNAIL_VIDEO -> MediaStoreApi.MediaType.VIDEO
        ...
        MEDIASTORE_DELETE_AUDIO -> MediaStoreApi.MediaType.AUDIO
        ...
        MEDIASTORE_DELETE_FILE -> MediaStoreApi.MediaType.FILE
        ...
        MEDIASTORE_DELETE_DOWNLOAD -> MediaStoreApi.MediaType.DOWNLOAD

        else -> null
      }

  fun requiresMediaUri(): Boolean =
      when (this) {
        MEDIASTORE_READ_IMAGE,
        MEDIASTORE_READ_VIDEO,
        MEDIASTORE_READ_AUDIO,
        ...
        MEDIASTORE_THUMBNAIL_VIDEO -> true

        else -> false
      }

  fun requiresFilePath(): Boolean =
      this in
          setOf(
              FILE_READ,
              FILE_WRITE,
              FILE_WRITE_THEN_OVERWRITE,
              FILE_OVERWRITE,
              FILE_WRITE_DENIED,
              FILE_DELETE,
              FILE_DELETE_DENIED,
  ...
  fun run(context: Context, args: TestCaseArgs = TestCaseArgs()): TestResult {
    ...
    return when (this) {
      ...
      MEDIASTORE_QUERY_READ_ONLY_IMAGE -> mediaStore.queryReadOnlyImage(args)
      ...
      FILE_WRITE_THEN_OVERWRITE -> file.writeThenOverwrite(args)
