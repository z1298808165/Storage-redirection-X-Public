...
internal fun UpdateScreen(
  ...
  val officialRepositoryUrl = remember {
    "https://github.com/${BuildConfig.OFFICIAL_RELEASE_REPOSITORY}"
  }
  LazyUpdateLayout(
      header = {
        BackPageHeader(
...
private fun LazyUpdateLayout(
  ...
  androidx.compose.foundation.lazy.LazyColumn(
      modifier = Modifier.fillMaxSize().appMeshBackground().overScrollVertical(),
      contentPadding =
          PaddingValues(
...
internal val UpdateChannelOptions =
    listOf(
